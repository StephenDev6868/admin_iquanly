    ...
    var b = function () {
        ...
        return function () {
            ...
            return b.Extend(c, b.Observable), c.prototype.render = function () {
                var b = a('<ul class="select2-results__options" roles="tree"></ul>');
                ...
                var d = a('<li roles="treeitem" aria-live="assertive" class="select2-results__option"></li>'), e = this.options.get("translations").get(b.message);
            ...
            return b.Extend(d, b.Observable), d.prototype.render = function () {
                var b = a('<span class="select2-selection" roles="combobox"  aria-haspopup="true" aria-expanded="false"></span>');
            ...
            return c.Extend(e, b), e.prototype.render = function () {
                ...
                return a.addClass("select2-selection--single"), a.html('<span class="select2-selection__rendered"></span><span class="select2-selection__arrow" roles="presentation"><b roles="presentation"></b></span>'), a
            ...
            return c.Extend(d, b), d.prototype.render = function () {
                ...
                var b = a('<li class="select2-selection__choice"><span class="select2-selection__choice__remove" roles="presentation">&times;</span></li>');
                return b
            }, d.prototype.update = function (a) {
            ...
            return d.prototype.render = function (b) {
                var c = a('<li class="select2-search select2-search--inline"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" roles="textbox" aria-autocomplete="list" /></li>');
            ...
            return c.prototype.render = function (b) {
                var c = b.call(this), d = a('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" roles="textbox" /></span>');
            ...
            return b.prototype.append = function (a, b) {
                ...
                var b = a('<li class="select2-results__option select2-results__option--load-more"roles="treeitem" aria-disabled="true"></li>'), c = this.options.get("translations").get("loadingMore");
