            ...
            <div class="col-lg-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <form class="row" action="{{ route('admin.wDevices.doCreate') }}" method="POST" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="col-md-6 form-group">
                                <label>Tên thiết bị</label>
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control" required placeholder="Nhập tên thiết bị"/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Mã thiết bị</label>
                                <input type="text" name="code" value="{{ old('code') }}" class="form-control" required placeholder="Nhập mã thiết bị"/>
                            </div>
                            <div class="col-md-6 form-group">
