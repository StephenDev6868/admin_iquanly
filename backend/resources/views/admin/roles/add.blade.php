        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Thêm nhóm phân quyền </h4>
                    <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <form class="row" action="{{ route('admin.roles.doCreate') }}" method="POST" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
{{--                            <div class="col-md-12 form-group">--}}
{{--                                <label>Chọn chhuyên mục chính</label>--}}
                                            ...
                                            <td class="d-flex">
                                                @foreach($permissions as $permission)
                                                    <div>
                                                        ...
                                                        <input type="checkbox" id="switch_{{ $key . '_' . $loop->index }}" name="{{ $key . '_' . ($loop->index + 1) }}" switch="none" checked/>
