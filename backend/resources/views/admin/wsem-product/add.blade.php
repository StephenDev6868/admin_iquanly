        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Thêm dụng cụ </h4>
                    <ol class="breadcrumb">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row" action="{{ route('admin.wTools.doCreate') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control" required placeholder="Nhập tên dụng cụ  "/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Mã dụng cụ  </label>
                                <input type="text" name="code" value="{{ old('code') }}" class="form-control" required placeholder="Nhập mã dụng cụ  "/>
                            </div>
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-12 form-group">
                                <label>Người giữ dụng cụ  cụ: </label>
