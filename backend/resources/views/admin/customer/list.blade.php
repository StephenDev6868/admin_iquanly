...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-add">
                    <a href="{{ route('admin.customers.create')  }}" class="btn btn-info mb-4">Thêm khách hàng mới</a>
                </div>
                        ...
                        <table class="table table-striped mb-0">
                            ...
                            @foreach($datas as $key => $data)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a href="{{ route('admin.customers.show', ['customer' => $data->getKey()])  }}" class="btn btn-success mr-2">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <form method="post" action="{{ route('admin.customers.delete', $data->getKey()) }}" onsubmit="return confirm('@lang('Confirm delete?')');">
                                            @csrf
                                            @method('DELETE')
