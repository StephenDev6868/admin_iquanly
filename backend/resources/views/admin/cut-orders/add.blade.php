        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Thêm sơ đồ cắt theo đơn hàng </h4>
                    <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        <h4 class="mt-0 header-title mb-3">Nhập thông tin sơ đồ cắt theo đơn hàng </h4>
                        <form class="row" action="{{ route('admin.wTools.doCreate') }}" method="POST" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="col-md-6 form-group">
                                <label>Tên sơ đồ cắt theo đơn hàng  </label>
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control" required placeholder="Nhập tên sơ đồ cắt theo đơn hàng  "/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Mã sơ đồ cắt theo đơn hàng  </label>
                                <input type="text" name="code" value="{{ old('code') }}" class="form-control" required placeholder="Nhập mã sơ đồ cắt theo đơn hàng  "/>
                            </div>
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-12 form-group">
                                <label>Người giữ sơ đồ cắt theo đơn hàng  cụ: </label>
