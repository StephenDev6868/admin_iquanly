...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Quản lý Dụng cụ</h4>
                    <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-add">
                    <a href="{{ route('admin.wTools.create')  }}" class="btn btn-info mb-4">Thêm Dụng cụ mới</a>
                </div>
                <div class="card m-b-20">
                    <div class="card-body">
                        <div class="table-title d-flex justify-content-between">
                            <h4 class="mt-0 header-title">Danh sách Dụng cụ</h4>
                            {{--                            {{ $boards->links() }}--}}
                        </div>
