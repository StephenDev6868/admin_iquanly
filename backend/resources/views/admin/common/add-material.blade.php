        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Thêm nguyên liệu </h4>
                    <ol class="breadcrumb">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row" action="{{ route('admin.commons.doCreateMaterial') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control" required placeholder="Nhập tên nguyên liệu   "/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Mã nguyên liệu   </label>
                                <input type="text" name="code" value="{{ old('code') }}" class="form-control" required placeholder="Nhập mã nguyên liệu   "/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Đơn vị </label>
                                <select id="unit" class="spr-text-field form-control" name="unit" required>
