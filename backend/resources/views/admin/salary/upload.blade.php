        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Thêm lương </h4>
                    <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        <h4 class="mt-0 header-title mb-3">Nhập thông tin lương </h4>
                        <form class="row" action="{{ route('admin.import.template') }}" method="POST" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="col-md-7 form-group">
                                <label>Chọn file excel</label>
                                <input type="file" name="upload_salary" class="filestyle" data-buttonname="btn-secondary">
                            </div>
