        ...
        <div class="card">
            <div class="card-body">
                <h3 class="text-center m-0">
                    <a href="index" class="logo logo-admin" style="font-size: 20px;">Trang Thông Tin Nhân viên</a>
                </h3>
                <div class="p-3">
                    @include('layouts.flash-message')
                    <form class="form-horizontal m-t-30" action="{{ route('doLoginStaff') }}" method="POST">
                        @csrf
                        @method('POST')
...
{{--                            </div>--}}
                            <div class="offset-8 col-6">
                                <button class="btn btn-info w-md waves-effect waves-light" type="submit">Đăng nhập</button>
                            </div>
                        </div>
